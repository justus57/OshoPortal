...
namespace OshoPortal.Webportal {
    ...
    public partial class webportal : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("urn:microsoft-dynamics-schemas/codeunit/webportal:GetItemList", RequestNamespace="urn:microsoft-dynamics-schemas/codeunit/webportal", ResponseElementName="GetItemList_Result", ResponseNamespace="urn:microsoft-dynamics-schemas/codeunit/webportal", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public void GetItemList(ref ItemList itemList, string employeeNo) {
        ...
        /// <remarks/>
        public void GetItemListAsync(ItemList itemList, string employeeNo) {
            this.GetItemListAsync(itemList, employeeNo, null);
        }
        
        /// <remarks/>
        public void GetItemListAsync(ItemList itemList, string employeeNo, object userState) {
            ...
            this.InvokeAsync("GetItemList", new object[] {
                        itemList,
                        employeeNo}, this.GetItemListOperationCompleted, userState);
        }
