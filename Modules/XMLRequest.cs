...
namespace OshoPortal.Modules
{
    ...
    {
        public static DataTable GetPageData(string status, string EmpNo, string RequestAS)
        {
            ...
            string tabledata = GetItemsList.Getitemlist(EmpNo, RequestAS, status);
